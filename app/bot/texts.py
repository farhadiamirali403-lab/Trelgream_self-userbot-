...
START = (
    "🤖 به پلتفرم ربات شخصی تلگرام خوش آمدید!\n\n"
    "در اینجا می‌توانید حساب تلگرام خود را متصل کنید، اشتراک فعال کنید "
    "و ربات شخصی (Userbot) خود را با بیش از ۱۰۰ قابلیت اجرا نمایید.\n\n"
